...
namespace ISM6225_Spring_2024_Assignment_2
{
    class Program
    {
        ...
        public static IList<int> MoveZeroes(int[] nums)
        {
            try
            {
                ...
                for (int i = 0; i < nums.Length; i++)
                {
                    if (nums[i] != 0)
                    {
                        // Place non-zero elements at the position indicated by nonZeroIndex
                        nums[nonZero_Index] = nums[i];
                        // Increment the nonZeroIndex to prepare for the next non-zero element placement
                        nonZero_Index++;
                    }
                }
        ...
        */
        ...
        public static int FindMaxConsecutiveOnes(int[] nums)
        {
            try
            {
                ...
                foreach (int number in nums)
                {
                    ...
                    {
                        // Reset the count of consecutive 1s
                        current_Count = 0;
                    }
                }
        ...
        Question 5:
        You are tasked with writing a program that converts a binary number to its equivalent decimal representation without using 
        bitwise operators or the `Math.Pow` function. You will implement a function called `BinaryToDecimal` which takes an 
        integer representing a binary number as input and returns its decimal equivalent. 
        ...
        */
        ...
        public static int BinaryToDecimal(int binary)
        {
            ...
            {
                int decimalNumber = 0;
                int baseValue = 1; // Base value for binary places: 1, 2, 4, 8, 16, ...

                // Iterate until all binary digits are processed
                while (binary > 0)
                {
                    ...
                    // Multiply the last digit by the corresponding base value and add to the decimal number
                    decimalNumber += lastDigit * baseValue;

                    // Update the base value for the next binary place
                    baseValue *= 2;
                }
        ...
        */
        ...
        public static int MaximumGap(int[] nums)
        {
            try
            {
                ...
                int max_diff = 0; // Initialize the maximum difference between successive elements
        ...
        */
        ...
        public static int LargestPerimeter(int[] nums)
        {
            try
            {
                ...
                // Start checking from the end to find the largest triangle perimeter
        ...
        */
        ...
        public static string RemoveOccurrences(string s, string part)
        {
            ...
            {
                int index;
                // Continue removing occurrences of 'part' until none are found
                while ((index = s.IndexOf(part)) != -1)
                {
                    // Remove the leftmost occurrence of part from s
                    s = s.Remove(index, part.Length);
                }
                // Return the string after all occurrences of 'part' are removed
                return s;
            }
            catch (Exception)
            {
